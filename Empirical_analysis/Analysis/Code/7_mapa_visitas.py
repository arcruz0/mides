...
arcpy.MakeXYEventLayer_management(table="geodata_cleaned.txt", in_x_field="longitude", in_y_field="latitude", out_layer="geocoding_Layer", spatial_reference="GEOGCS['GCS_WGS_1984',DATUM['D_WGS_1984',SPHEROID['WGS_1984',6378137.0,298.257223563]],PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]];-400 -400 1000000000;-100000 10000;-100000 10000;8.98315284119522E-09;0.001;0.001;IsHighPrecision", in_z_field="")
addLayer = arcpy.mapping.Layer("geocoding_Layer")
arcpy.mapping.AddLayer(dfArcGIS, addLayer)
